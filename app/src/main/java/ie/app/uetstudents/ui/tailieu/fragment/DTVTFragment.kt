...
import kotlinx.android.synthetic.main.fragment_d_t_v_t.*
...
class DTVTFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_d_t_v_t, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        list_subjects_dtvt.layoutManager = LinearLayoutManager(requireContext())
        list_subjects_dtvt.adapter = adapter
