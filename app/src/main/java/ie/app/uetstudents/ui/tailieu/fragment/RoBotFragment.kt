...
class RoBotFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        list_subjects_robot.layoutManager = LinearLayoutManager(requireContext())
        list_subjects_robot.adapter = adapter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_ro_bot, container, false)
    }
