...
import kotlinx.android.synthetic.main.fragment_ro_bot2.*
 ...
 * Use the [RoBotFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class dethi_RoBotFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_ro_bot2, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        dethi_list_subjects_robot.layoutManager = LinearLayoutManager(requireContext())
        dethi_list_subjects_robot.adapter = adapter
